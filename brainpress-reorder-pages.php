<?php
/*
Plugin Name: Neuordnung von Einheiten in BrainPress
Plugin URI: 
Description: Bietet eine (grobe) Möglichkeit, Seiten (auch als Abschnittseinheiten bezeichnet) in BrainPress ohne Copy & Paste-Module neu anzuordnen. Dies ist eine vorläufige Software! BENUTZE ES AUF EIGENES RISIKO!
Version: 0.5
Author: DerN3rd
License: GPL2
*/
